    ...
    <Section id="nosotros">
      <div className="flex flex-col lg:flex-row gap-16 items-center">
        ...
        <div className="lg:w-1/2">
          ...
          <h2 className="font-serif text-4xl md:text-5xl text-elegant-black mb-8 leading-tight">
          ...
          <div className="grid grid-cols-2 gap-8 mt-12 border-t border-gray-200 pt-8">
            <div>
              ...
              <span className="text-sm uppercase tracking-wider text-gray-500">Años de Experiencia</span>
            </div>
            <div>
              <span className="block font-serif text-4xl text-burgundy mb-2">500+</span>
              <span className="text-sm uppercase tracking-wider text-gray-500">Eventos Exitosos</span>
            </div>
          </div>
        </div>

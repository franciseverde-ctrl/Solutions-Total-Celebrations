...
const Footer: React.FC = () => {
  return (
    <footer className="bg-elegant-black text-white pt-20 pb-10 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
        <div className="grid md:grid-cols-3 gap-12 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 border border-white/20 flex items-center justify-center rounded-full hover:bg-gold hover:border-gold hover:text-white transition-all text-gray-400">
                <Instagram size={18} />
              </a>
              <a href="#" className="w-10 h-10 border border-white/20 flex items-center justify-center rounded-full hover:bg-gold hover:border-gold hover:text-white transition-all text-gray-400">
                <Facebook size={18} />
        ...
        <div className="border-t border-white/10 mt-16 pt-8 text-center text-gray-500 text-xs font-light tracking-wide">

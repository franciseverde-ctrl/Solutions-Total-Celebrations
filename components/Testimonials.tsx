  ...
  return (
    <Section id="testimonios" className="bg-white">
      <div className="text-center mb-16">
        <h2 className="font-serif text-4xl md:text-5xl text-elegant-black mb-6">Lo que dicen nuestros clientes</h2>
      </div>

      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
        {[1, 2, 3].map((i) => (
          <div key={i} className="bg-soft-white p-10 flex flex-col items-center text-center relative">
            <div className="text-gold flex gap-1 mb-6">
              {[...Array(5)].map((_, idx) => (
                <Star key={idx} size={16} fill="#D4A85F" stroke="none" />
              ))}
            </div>
            <p className="font-serif text-xl italic text-gray-700 mb-6 leading-relaxed">
            ...
            <div>
              ...
              <span className="text-xs text-gray-500 mt-1 block">Boda en Ciudad Amurallada</span>
            </div>
            {/* Quote decoration */}
